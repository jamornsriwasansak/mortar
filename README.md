...
Mortar is a small physically based renderer with agnostic api. It can use either Vulkan or DX12 as a backend. 

One of it abilities is to utilizes ray-tracing api to generate the following images:
