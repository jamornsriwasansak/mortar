...
bool planeBoxOverlap(vec3 normal, vec3 vert, vec3 maxbox)	// -NJMP-
{
    int q;
    vec3 vmin;
    vec3 vmax;
...
bool triBoxOverlap(vec3 boxcenter, vec3 boxhalfsize, vec3 triverts[3])
{
    ...
    vec3 e0 = v1 - v0;      /* tri edge 0 */
    vec3 e1 = v2 - v1;      /* tri edge 1 */
    vec3 e2 = v0 - v2;      /* tri edge 2 */
